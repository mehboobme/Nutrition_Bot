...
class NutritionBot:
    def __init__(self):
        ...
        self.memory = MemoryClient(api_key=os.getenv.get("MEM0_API_KEY"))  # Complete the code to define the memory client API key
    ...
    def handle_customer_query(self, user_id: str, query: str) -> str:
        ...
        for item in relevant_history:
            conversation = item.get("memory", [])
            for turn in conversation:
                role = turn.get("role", "unknown").capitalize()  # "User" or "Assistant"
